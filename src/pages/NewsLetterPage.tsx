      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 p-6 lg:p-8 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            {/* Header */}
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-2">Registration Completed </h2>
              <h3 className="text-2xl font-semibold text-white mb-4">Subscribe to our newsletters.</h3>
              <p className="text-gray-400">Now you can setup your projects and teams</p>
            </div>
