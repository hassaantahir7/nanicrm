      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 p-6 lg:p-12 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            {/* Header */}
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-2">Welcome to our CRM.</h2>
              <h3 className="text-2xl font-semibold text-white mb-4">Sign Up to getting started.</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="relative">
                ...
                />
                <User className="absolute right-0 top-[65%] -translate-y-1/2 h-5 w-5 text-gray-500" />
              </div>
